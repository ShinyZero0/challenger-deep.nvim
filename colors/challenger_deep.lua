...
local syntax = {
	...
	LineNr = { fg = challenger_deeper.bg_dark, bg = challenger_deeper.bg_subtle },
	...
	Visual = { bg = challenger_deeper.bg_dark },
	...
	MatchParen = { bg = challenger_deeper.bg_dark, fg = challenger_deeper.cyan, bold = true },
