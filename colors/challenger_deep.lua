...
local syntax = {
	...
	Comment = { fg = challenger_deeper.lighter_gray, italic = false },
	...
	Operator = { fg = challenger_deeper.fg },
	...
	MatchParen = { bg = challenger_deeper.dark_asphalt, fg = challenger_deeper.purple, bold = true },
